...
var welive_auto = 2; //客服对话窗口自动展开时间(秒), 0表示不自动展开
var welive_color_style = 2; //客服小面板配色风格, 1-5可选, 与welive后台设置保持一致
...
if(window.top != window.self){
	...
	function welive_mobile(){
		...
		welive_css.setAttribute("href", welive_url + "mobile/welive.css?v=520");
		...
		welive_obj.drag.onclick = function(){
			...
			if(!welive_loaded) {
				...
				$_$("welive_iframe").src = welive_url + "mobile/welive_index.php?a=621256861&gid=" + welive_gid + "&r=" + Math.random() + "&d=" + welive_same + "&url=" + url;
			}
	...
	function welive_web(){
		...
		var welive_css = document.createElement("link");
		welive_css.setAttribute("rel", "stylesheet");
		welive_css.setAttribute("href", welive_url + "public/welive.css?v=520");
		document.getElementsByTagName("head")[0].appendChild(welive_css);
		...
		welive_online.onclick = function(){
			...
			if(!welive_loaded) {
				...
				location.hash = "";
				var url = window.location.href;
				$_$("welive_iframe").src = welive_url + "welive2618.php?a=621256861&gid=" + welive_gid + "&r=" + Math.random() + "&d=" + welive_same + "&url=" + url;
