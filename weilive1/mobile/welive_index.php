...
<link rel="stylesheet" href="mobile.css?v=520">
...
guest = {gid: ' . $gid . ', fn: "", aid: 0, au: 0, an: "", sess: "", lang: ' . IS_CHINESE . ', agent: "' . $agent . '", fromurl: "' . $fromurl . '"},
...
<script type="text/javascript" src="mobile_free.js?v=520"></script>
</body>
</html>';
