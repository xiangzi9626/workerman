...
<link rel="shortcut icon" href="' . SYSDIR . 'public/img/favicon.ico" type="image/x-icon"> 
<link rel="stylesheet" type="text/css" href="'. SYSDIR .'public/admin.css?v=520">
<link rel="stylesheet" type="text/css" href="'. SYSDIR .'public/easyDialog/easyDialog.css">
<link rel="stylesheet" type="text/css" href="'. SYSDIR .'public/jquery.tipTip.css">
<script src="'. SYSDIR .'public/jquery191.js" type="text/javascript"></script>
<script src="'. SYSDIR .'public/jquery.tipTip.js" type="text/javascript"></script>
...
<script src="'. SYSDIR .'public/support_free.js?v=520" type="text/javascript"></script>
</head>
<body class="online">
<script src="'. SYSDIR .'public/easyDialog/easyDialog.js" type="text/javascript"></script>
	...
	<div id="topbar">
		<div id="topmenu">
			...
			<dl>
				...
				<dd>
					<div>
						...
						<li><a href="' . BURL('users') . '">客服管理</a></li>
			...
			<dl>
				...
				<dd>
					<div>
						<li class="first"><a href="' . BURL('comments') . '">留言管理</a></li>
						<li class="last"></li>
					</div>
				</dd>
			</dl>
			<dl>
				...
				<dd>
					<div>
						<li class="first"><a href="' . BURL('messages') . '">对话记录管理</a></li>
						<li><a href="' . BURL('rating') . '">访客评价管理</a></li>
						<li class="last"><a href="' . BURL('upload_img') . '">上传图片清理</a></li>
					</div>
				</dd>
			</dl>
			<dl>
				<dt><a href="' . BURL('robot') . '">智能</a></dt>
				<dd>
					<div>
						<li class="first"><a href="' . BURL('robot') . '">机器人客服管理</a></li>
						<li><a href="' . BURL('phrases/add') . '">添加常用短语</a></li>
						<li class="last"><a href="' . BURL('phrases') . '">常用短语管理</a></li>
					</div>
				</dd>
			</dl>
			<dl>
				...
				<dl class="home">
				<dt><a href="'.BURL('Advertisement') . '">广告位</a></dt>
			 </dl>
			<dl class="last"></dl>
		</div>
	...
	<div id="topbar">
		<div id="topmenu">
			...
			<dl>
				...
				<dd>
					<div>
						<li class="first last"><a href="' . Iif($isAdmin, BURL('messages'), BURL('mymessages')) . '"' . $blank . '>对话记录管理</a></li>
					</div>
				</dd>
			</dl>
			<dl>
				...
				<dd>
					<div>
						...
						<li class="last"><a href="' . Iif($isAdmin, BURL('phrases'), BURL('myphrases')) . '"' . $blank . '>常用短语管理</a></li>
					</div>
				</dd>
			</dl>
			<dl>
